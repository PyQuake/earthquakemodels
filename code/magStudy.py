...
def loadModelSC(type, year, region, depth, i):
	if type == 'gaModel':
		filename = '../Zona3/scModel/gamodel'+region+'_'+str(depth)+'_'+str(year)+str(i)+'.txt'
		modelo=etasGa.loadModelFromFile(filename)
	if type == 'sc_hybrid_gaModel':
		filename = '../Zona2/sc_hybrid_gaModel/hybrid_gaModel'+region+'_'+str(depth)+'_'+str(year)+'_'+str(i)+'.txt'
		modelo=etasGa.loadModelFromFile(filename)
	if type == 'sc_hybrid_ListaGA_New':
		filename = '../Zona2/sc_hybrid_ListaGA_New/hybrid_ListaGA_New'+region+'_'+str(depth)+'_'+str(year)+'_'+str(i)+'.txt'
		modelo=etasGa.loadModelFromFile(filename)
	elif region == 'EastJapan':
		filename = '../Zona3/scModel/eastgamodel'+region+'_'+str(depth)+'_'+str(year)+str(i)+'.txt'
		modelo=etasGa.loadModelFromFile(filename)
	else:
		filename = '../Zona3/scModel/listgamodel'+region+'_'+str(depth)+'_'+str(year)+str(i)+'.txt'
		modelo=etasGa.loadModelFromFile(filename)
	fileEtasim="../Zona/paper_exp/etasim1.txt"
	modelo=etasGa.simpleHibrid(modelo,fileEtasim,"../Zona/paper_exp/testeModelCatalog.txt")
	return modelo
...
def saveModelSC(modelL, type, year, region, depth, i, minMag, maxMag):
	...
	file = type.split('_')
	if type == 'gaModel':
		etasGa.saveModelToFile(modelL,'../Zona2/magStudy/gamodelSC/'+region+'_'+str(depth)+'_'+str(year)+str(i)+'_'+str(minMag)+".txt")
	if type == 'sc_hybrid_gaModel':
		filename =  "../Zona2/dataForR/magStudy/sc_hybrid_gaModel/"+region+"_"+str(depth)+"_"+str(year)+'_'+str(minMag)+".txt"
	if type == 'sc_hybrid_ListaGA_New':
		filename =  "../Zona2/dataForR/magStudy/sc_hybrid_ListaGA_New/"+region+"_"+str(depth)+"_"+str(year)+'_'+str(minMag)+".txt"	
	else:
		etasGa.saveModelToFile(modelL,'../Zona2/magStudy/listgamodel/'+region+'_'+str(depth)+'_'+str(year)+str(i)+'_'+str(minMag)+".txt")
...
def converter2leastBest(type, region, depth,minMag,maxMag, year_begin, year_end):
	...
	while(year<=year_end):
		...
		for i in range(10):
			if type == 'gaModel':
				filename = '../Zona2/magStudy/gamodelSC/'+region+'_'+str(depth)+'_'+str(year)+str(i)+'_'+str(minMag)+".txtloglikelihood.txt"
			else:
				filename = '../Zona2/magStudy/listgamodel/'+region+'_'+str(depth)+'_'+str(year)+str(i)+'_'+str(minMag)+".txtloglikelihood.txt"
				# if region == 'EastJapan':
		...
		if type == 'gaModel':
			filename =  "../Zona2/dataForR/magStudy/gamodelSC/"+region+"_"+str(depth)+"_"+str(year)+'_'+str(minMag)+".txt"
		if type == 'sc_hybrid_gaModel':
			filename =  "../Zona2/dataForR/magStudy/sc_hybrid_gaModel/"+region+"_"+str(depth)+"_"+str(year)+'_'+str(minMag)+".txt"
		if type == 'sc_hybrid_ListaGA_New':
			filename =  "../Zona2/dataForR/magStudy/sc_hybrid_ListaGA_New/"+region+"_"+str(depth)+"_"+str(year)+'_'+str(minMag)+".txt"
		else:
			filename =  "../Zona2/dataForR/magStudy/listgamodel/"+region+"_"+str(depth)+"_"+str(year)+'_'+str(minMag)+".txt"
...
def main():
	...
	# types = ()
	types = ('sc_hybrid_gaModel','sc_hybrid_ListaGA_New','gaModel', 'listaGA_new')
