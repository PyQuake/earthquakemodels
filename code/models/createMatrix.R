#!/usr/bin/env Rscript
setwd("~/Documents/estudos/unb/earthquakemodels/Zona/paper_exp_2011")
options(scipen=999)
library(grid)
...
calcMedia = function(year, region,r,c){
  soma = rep(0, r*c)
  setwd("~/Documents/estudos/unb/earthquakemodels/Zona/paper_exp_2011")
  for(i in 1:20){
...
reducedAgainstGAModel2000=t.test(as.numeric(raw_data1), as.numeric(raw_data2))
year=2005
#sem ri
while(year<=2010){
  #etas
