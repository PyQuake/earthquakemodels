    ...
    while(year <= year_end):
        ...
        for i in range(10):
            ...
            etasGa.saveModelToFile(
                modelL,
                "../Zona2/hybrid_ListaGA_New/hybrid_ListaGA_New" +
                region +
                '_' +
                str(depth) +
                '_' +
            ...
            etasGa.saveModelToFile(
                modelL,
                "../Zona2/hybrid_gaModel/hybrid_gaModel" +
                region +
                '_' +
                str(depth) +
                '_' +
...
def execCreatingHybridWindow(region, depth, year_begin, year_end):
    ...
    while(year <= year_end):
        ...
        for i in range(10):
            ...
            etasGa.saveModelToFile(
                modelL,
                "../Zona2/clustered_hybrid_ListaGA_New/hybrid_ListaGA_New" +
                region +
                '_' +
                str(depth) +
                '_' +
            ...
            etasGa.saveModelToFile(
                modelL,
                "../Zona2/clustered_hybrid_gaModel/hybrid_gaModel" +
                region +
                '_' +
                str(depth) +
                '_' +
...
def execCreatingHybridSLC(region, depth, year_begin, year_end):
    ...
    while(year <= year_end):
        ...
        for i in range(10):
            ...
            etasGa.saveModelToFile(
                modelL,
                "../Zona2/clusteredII_hybrid_ListaGA_New/hybrid_ListaGA_New" +
                region +
                '_' +
                str(depth) +
                '_' +
            ...
            etasGa.saveModelToFile(
                modelL,
                "../Zona2/clusteredII_hybrid_gaModel/hybrid_gaModel" +
                region +
                '_' +
                str(depth) +
                '_' +
