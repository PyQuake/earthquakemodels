nohup ssh cluster2.local 'cd mpi_projects/earthquakemodels/result_exp_benchmark/gaBenchmarksStudy; nohup sh runme1-3.sh &' &> trash &
nohup ssh cluster4.local 'cd mpi_projects/earthquakemodels/result_exp_benchmark/gaBenchmarksStudy; nohup sh runme4-6.sh &' &> trash &
nohup ssh cluster5.local 'cd mpi_projects/earthquakemodels/result_exp_benchmark/gaBenchmarksStudy; nohup sh runme7-9.sh &' &> trash &
