...
RANDOM=1341
# create middle gen
nohup python2.7 benchmarks-pseudo-adaptative/benchmarks-gamodelF13.py -tournsize 2 -params  'benchmarks-pseudo-adaptative/gaParams.txt' &
nohup python2.7 benchmarks-pseudo-adaptative/benchmarks-gamodelF14.py -tournsize 2 -params  'benchmarks-pseudo-adaptative/gaParams.txt' &
nohup python2.7 benchmarks-pseudo-adaptative/benchmarks-gamodelF15.py -tournsize 2 -params  'benchmarks-pseudo-adaptative/gaParams.txt' & 
wait
# random set.seed
RANDOM=1342
# k loop
