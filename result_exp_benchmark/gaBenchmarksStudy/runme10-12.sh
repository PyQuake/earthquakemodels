...
RANDOM=1341
# create middle gen
nohup python2.7 benchmarks-pseudo-adaptative/benchmarks-gamodelF10.py -tournsize 2 -params  'benchmarks-pseudo-adaptative/gaParams.txt' &
nohup python2.7 benchmarks-pseudo-adaptative/benchmarks-gamodelF11.py -tournsize 2 -params  'benchmarks-pseudo-adaptative/gaParams.txt' &
nohup python2.7 benchmarks-pseudo-adaptative/benchmarks-gamodelF12.py -tournsize 2 -params  'benchmarks-pseudo-adaptative/gaParams.txt' & 
wait
# random set.seed
RANDOM=1342
# k loop
