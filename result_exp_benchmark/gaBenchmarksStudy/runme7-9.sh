...
do
	...
	do
		...
		nohup python2.7 benchmarks/benchmarks-gamodelF7.py -tournsize "$i" -params  'benchmarks/gaParams.txt' &> 'f7_'$i'_'$j'.txt' &
		nohup python2.7 benchmarks/benchmarks-gamodelF8.py -tournsize "$i" -params  'benchmarks/gaParams.txt' &> 'f8_'$i'_'$j'.txt' &
		nohup python2.7 benchmarks/benchmarks-gamodelF9.py -tournsize "$i" -params  'benchmarks/gaParams.txt' &> 'f9_'$i'_'$j'.txt' &
		wait
